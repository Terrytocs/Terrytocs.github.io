...
var temp_key = "temp_f90870962aefb4abad0046d2aac0e1b2";
...
class AnimeNews {
  constructor(imgId, titleId, altTitleId, ratingId, synopsisId) {
    ...
    anime_list_xhr.setRequestHeader("x-cors-api-key", temp_key);
    ...
    anime_list_xhr.addEventListener("load", () => {
      if (anime_list_xhr.status === 200) {
        ...
        anime_xhr.setRequestHeader("x-cors-api-key", temp_key);
